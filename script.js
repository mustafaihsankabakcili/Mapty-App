...
class App {
    ...
    constructor(){
        ...
        // Event Listener for Form. After we submit it, we will see popup on map
        form.addEventListener('submit', this._newWorkout.bind(this));

        // Event Listener for Activity Type (Running - Cycling)
        inputType.addEventListener('change', this._elevationField)
